...
// Constructors
 ...
 PREFIX_CB_In::PREFIX_CB_In()   : Instruction( "CB",    "PREFIX CB", "----", 0xCB, 1,  4, VERBOSE_FLAG) { 
     _cb_instructions = std::vector<std::unique_ptr<Instruction> >(0x100); 
     _cb_instructions[0x00] = std::unique_ptr<Instruction>(new   CB_RLC_B_In());
     _cb_instructions[0x01] = std::unique_ptr<Instruction>(new   CB_RLC_C_In());
     _cb_instructions[0x02] = std::unique_ptr<Instruction>(new   CB_RLC_D_In());
     _cb_instructions[0x03] = std::unique_ptr<Instruction>(new   CB_RLC_E_In());
     _cb_instructions[0x04] = std::unique_ptr<Instruction>(new   CB_RLC_H_In());
     _cb_instructions[0x05] = std::unique_ptr<Instruction>(new   CB_RLC_L_In());
     _cb_instructions[0x06] = std::unique_ptr<Instruction>(new CB_RLC_mHL_In());
     _cb_instructions[0x07] = std::unique_ptr<Instruction>(new   CB_RLC_A_In());
     _cb_instructions[0x08] = std::unique_ptr<Instruction>(new   CB_RRC_B_In());
     _cb_instructions[0x09] = std::unique_ptr<Instruction>(new   CB_RRC_C_In());
     _cb_instructions[0x0A] = std::unique_ptr<Instruction>(new   CB_RRC_D_In());
     _cb_instructions[0x0B] = std::unique_ptr<Instruction>(new   CB_RRC_E_In());
     _cb_instructions[0x0C] = std::unique_ptr<Instruction>(new   CB_RRC_H_In());
     _cb_instructions[0x0D] = std::unique_ptr<Instruction>(new   CB_RRC_L_In());
     _cb_instructions[0x0E] = std::unique_ptr<Instruction>(new CB_RRC_mHL_In());
     _cb_instructions[0x0F] = std::unique_ptr<Instruction>(new   CB_RRC_A_In());
     
     _cb_instructions[0x10] = std::unique_ptr<Instruction>(new   CB_RL_B_In());
     _cb_instructions[0x11] = std::unique_ptr<Instruction>(new   CB_RL_C_In());
     _cb_instructions[0x12] = std::unique_ptr<Instruction>(new   CB_RL_D_In());
     _cb_instructions[0x13] = std::unique_ptr<Instruction>(new   CB_RL_E_In());
     _cb_instructions[0x14] = std::unique_ptr<Instruction>(new   CB_RL_H_In());
     _cb_instructions[0x15] = std::unique_ptr<Instruction>(new   CB_RL_L_In());
     _cb_instructions[0x16] = std::unique_ptr<Instruction>(new CB_RL_mHL_In());
     _cb_instructions[0x17] = std::unique_ptr<Instruction>(new   CB_RL_A_In());
     _cb_instructions[0x18] = std::unique_ptr<Instruction>(new   CB_RR_B_In());
     _cb_instructions[0x19] = std::unique_ptr<Instruction>(new   CB_RR_C_In());
     _cb_instructions[0x1A] = std::unique_ptr<Instruction>(new   CB_RR_D_In());
     _cb_instructions[0x1B] = std::unique_ptr<Instruction>(new   CB_RR_E_In());
     _cb_instructions[0x1C] = std::unique_ptr<Instruction>(new   CB_RR_H_In());
     _cb_instructions[0x1D] = std::unique_ptr<Instruction>(new   CB_RR_L_In());
     _cb_instructions[0x1E] = std::unique_ptr<Instruction>(new CB_RR_mHL_In());
     _cb_instructions[0x1F] = std::unique_ptr<Instruction>(new   CB_RR_A_In());
     
     _cb_instructions[0x20] = std::unique_ptr<Instruction>(new   CB_SLA_B_In());
     _cb_instructions[0x21] = std::unique_ptr<Instruction>(new   CB_SLA_C_In());
     _cb_instructions[0x22] = std::unique_ptr<Instruction>(new   CB_SLA_D_In());
     _cb_instructions[0x23] = std::unique_ptr<Instruction>(new   CB_SLA_E_In());
     _cb_instructions[0x24] = std::unique_ptr<Instruction>(new   CB_SLA_H_In());
     _cb_instructions[0x25] = std::unique_ptr<Instruction>(new   CB_SLA_L_In());
     _cb_instructions[0x26] = std::unique_ptr<Instruction>(new CB_SLA_mHL_In());
     _cb_instructions[0x27] = std::unique_ptr<Instruction>(new   CB_SLA_A_In());
     _cb_instructions[0x28] = std::unique_ptr<Instruction>(new   CB_SRA_B_In());
     _cb_instructions[0x29] = std::unique_ptr<Instruction>(new   CB_SRA_C_In());
     _cb_instructions[0x2A] = std::unique_ptr<Instruction>(new   CB_SRA_D_In());
     _cb_instructions[0x2B] = std::unique_ptr<Instruction>(new   CB_SRA_E_In());
     _cb_instructions[0x2C] = std::unique_ptr<Instruction>(new   CB_SRA_H_In());
     _cb_instructions[0x2D] = std::unique_ptr<Instruction>(new   CB_SRA_L_In());
     _cb_instructions[0x2E] = std::unique_ptr<Instruction>(new CB_SRA_mHL_In());
     _cb_instructions[0x2F] = std::unique_ptr<Instruction>(new   CB_SRA_A_In());
     
     _cb_instructions[0x30] = std::unique_ptr<Instruction>(new   CB_SWAP_B_In());
     _cb_instructions[0x31] = std::unique_ptr<Instruction>(new   CB_SWAP_C_In());
     _cb_instructions[0x32] = std::unique_ptr<Instruction>(new   CB_SWAP_D_In());
     _cb_instructions[0x33] = std::unique_ptr<Instruction>(new   CB_SWAP_E_In());
     _cb_instructions[0x34] = std::unique_ptr<Instruction>(new   CB_SWAP_H_In());
     _cb_instructions[0x35] = std::unique_ptr<Instruction>(new   CB_SWAP_L_In());
     _cb_instructions[0x36] = std::unique_ptr<Instruction>(new CB_SWAP_mHL_In());
     _cb_instructions[0x37] = std::unique_ptr<Instruction>(new   CB_SWAP_A_In());
     _cb_instructions[0x38] = std::unique_ptr<Instruction>(new    CB_SRL_B_In());
     _cb_instructions[0x39] = std::unique_ptr<Instruction>(new    CB_SRL_C_In());
     _cb_instructions[0x3A] = std::unique_ptr<Instruction>(new    CB_SRL_D_In());
     _cb_instructions[0x3B] = std::unique_ptr<Instruction>(new    CB_SRL_E_In());
     _cb_instructions[0x3C] = std::unique_ptr<Instruction>(new    CB_SRL_H_In());
     _cb_instructions[0x3D] = std::unique_ptr<Instruction>(new    CB_SRL_L_In());
     _cb_instructions[0x3E] = std::unique_ptr<Instruction>(new  CB_SRL_mHL_In());
     _cb_instructions[0x3F] = std::unique_ptr<Instruction>(new    CB_SRL_A_In());
     
     _cb_instructions[0x40] = std::unique_ptr<Instruction>(new   BIT_0_B_In());
     _cb_instructions[0x41] = std::unique_ptr<Instruction>(new   BIT_0_C_In());
     _cb_instructions[0x42] = std::unique_ptr<Instruction>(new   BIT_0_D_In());
     _cb_instructions[0x43] = std::unique_ptr<Instruction>(new   BIT_0_E_In());
     _cb_instructions[0x44] = std::unique_ptr<Instruction>(new   BIT_0_H_In());
     _cb_instructions[0x45] = std::unique_ptr<Instruction>(new   BIT_0_L_In());
     _cb_instructions[0x46] = std::unique_ptr<Instruction>(new BIT_0_mHL_In());
     _cb_instructions[0x47] = std::unique_ptr<Instruction>(new   BIT_0_A_In());
     _cb_instructions[0x48] = std::unique_ptr<Instruction>(new   BIT_1_B_In());
     _cb_instructions[0x49] = std::unique_ptr<Instruction>(new   BIT_1_C_In());
     _cb_instructions[0x4A] = std::unique_ptr<Instruction>(new   BIT_1_D_In());
     _cb_instructions[0x4B] = std::unique_ptr<Instruction>(new   BIT_1_E_In());
     _cb_instructions[0x4C] = std::unique_ptr<Instruction>(new   BIT_1_H_In());
     _cb_instructions[0x4D] = std::unique_ptr<Instruction>(new   BIT_1_L_In());
     _cb_instructions[0x4E] = std::unique_ptr<Instruction>(new BIT_1_mHL_In());
     _cb_instructions[0x4F] = std::unique_ptr<Instruction>(new   BIT_1_A_In());
     
     _cb_instructions[0x50] = std::unique_ptr<Instruction>(new   BIT_2_B_In());
     _cb_instructions[0x51] = std::unique_ptr<Instruction>(new   BIT_2_C_In());
     _cb_instructions[0x52] = std::unique_ptr<Instruction>(new   BIT_2_D_In());
     _cb_instructions[0x53] = std::unique_ptr<Instruction>(new   BIT_2_E_In());
     _cb_instructions[0x54] = std::unique_ptr<Instruction>(new   BIT_2_H_In());
     _cb_instructions[0x55] = std::unique_ptr<Instruction>(new   BIT_2_L_In());
     _cb_instructions[0x56] = std::unique_ptr<Instruction>(new BIT_2_mHL_In());
     _cb_instructions[0x57] = std::unique_ptr<Instruction>(new   BIT_2_A_In());
     _cb_instructions[0x58] = std::unique_ptr<Instruction>(new   BIT_3_B_In());
     _cb_instructions[0x59] = std::unique_ptr<Instruction>(new   BIT_3_C_In());
     _cb_instructions[0x5A] = std::unique_ptr<Instruction>(new   BIT_3_D_In());
     _cb_instructions[0x5B] = std::unique_ptr<Instruction>(new   BIT_3_E_In());
     _cb_instructions[0x5C] = std::unique_ptr<Instruction>(new   BIT_3_H_In());
     _cb_instructions[0x5D] = std::unique_ptr<Instruction>(new   BIT_3_L_In());
     _cb_instructions[0x5E] = std::unique_ptr<Instruction>(new BIT_3_mHL_In());
     _cb_instructions[0x5F] = std::unique_ptr<Instruction>(new   BIT_3_A_In());
     
     _cb_instructions[0x60] = std::unique_ptr<Instruction>(new   BIT_4_B_In());
     _cb_instructions[0x61] = std::unique_ptr<Instruction>(new   BIT_4_C_In());
     _cb_instructions[0x62] = std::unique_ptr<Instruction>(new   BIT_4_D_In());
     _cb_instructions[0x63] = std::unique_ptr<Instruction>(new   BIT_4_E_In());
     _cb_instructions[0x64] = std::unique_ptr<Instruction>(new   BIT_4_H_In());
     _cb_instructions[0x65] = std::unique_ptr<Instruction>(new   BIT_4_L_In());
     _cb_instructions[0x66] = std::unique_ptr<Instruction>(new BIT_4_mHL_In());
     _cb_instructions[0x67] = std::unique_ptr<Instruction>(new   BIT_4_A_In());
     _cb_instructions[0x68] = std::unique_ptr<Instruction>(new   BIT_5_B_In());
     _cb_instructions[0x69] = std::unique_ptr<Instruction>(new   BIT_5_C_In());
     _cb_instructions[0x6A] = std::unique_ptr<Instruction>(new   BIT_5_D_In());
     _cb_instructions[0x6B] = std::unique_ptr<Instruction>(new   BIT_5_E_In());
     _cb_instructions[0x6C] = std::unique_ptr<Instruction>(new   BIT_5_H_In());
     _cb_instructions[0x6D] = std::unique_ptr<Instruction>(new   BIT_5_L_In());
     _cb_instructions[0x6E] = std::unique_ptr<Instruction>(new BIT_5_mHL_In());
     _cb_instructions[0x6F] = std::unique_ptr<Instruction>(new   BIT_5_A_In());
     
     _cb_instructions[0x70] = std::unique_ptr<Instruction>(new   BIT_6_B_In());
     _cb_instructions[0x71] = std::unique_ptr<Instruction>(new   BIT_6_C_In());
     _cb_instructions[0x72] = std::unique_ptr<Instruction>(new   BIT_6_D_In());
     _cb_instructions[0x73] = std::unique_ptr<Instruction>(new   BIT_6_E_In());
     _cb_instructions[0x74] = std::unique_ptr<Instruction>(new   BIT_6_H_In());
     _cb_instructions[0x75] = std::unique_ptr<Instruction>(new   BIT_6_L_In());
     _cb_instructions[0x76] = std::unique_ptr<Instruction>(new BIT_6_mHL_In());
     _cb_instructions[0x77] = std::unique_ptr<Instruction>(new   BIT_6_A_In());
     _cb_instructions[0x78] = std::unique_ptr<Instruction>(new   BIT_7_B_In());
     _cb_instructions[0x79] = std::unique_ptr<Instruction>(new   BIT_7_C_In());
     _cb_instructions[0x7A] = std::unique_ptr<Instruction>(new   BIT_7_D_In());
     _cb_instructions[0x7B] = std::unique_ptr<Instruction>(new   BIT_7_E_In());
     _cb_instructions[0x7C] = std::unique_ptr<Instruction>(new   BIT_7_H_In());
     _cb_instructions[0x7D] = std::unique_ptr<Instruction>(new   BIT_7_L_In());
     _cb_instructions[0x7E] = std::unique_ptr<Instruction>(new BIT_7_mHL_In());
     _cb_instructions[0x7F] = std::unique_ptr<Instruction>(new   BIT_7_A_In());
     
     _cb_instructions[0x80] = std::unique_ptr<Instruction>(new   RES_0_B_In());
     _cb_instructions[0x81] = std::unique_ptr<Instruction>(new   RES_0_C_In());
     _cb_instructions[0x82] = std::unique_ptr<Instruction>(new   RES_0_D_In());
     _cb_instructions[0x83] = std::unique_ptr<Instruction>(new   RES_0_E_In());
     _cb_instructions[0x84] = std::unique_ptr<Instruction>(new   RES_0_H_In());
     _cb_instructions[0x85] = std::unique_ptr<Instruction>(new   RES_0_L_In());
     _cb_instructions[0x86] = std::unique_ptr<Instruction>(new RES_0_mHL_In());
     _cb_instructions[0x87] = std::unique_ptr<Instruction>(new   RES_0_A_In());
     _cb_instructions[0x88] = std::unique_ptr<Instruction>(new   RES_1_B_In());
     _cb_instructions[0x89] = std::unique_ptr<Instruction>(new   RES_1_C_In());
     _cb_instructions[0x8A] = std::unique_ptr<Instruction>(new   RES_1_D_In());
     _cb_instructions[0x8B] = std::unique_ptr<Instruction>(new   RES_1_E_In());
     _cb_instructions[0x8C] = std::unique_ptr<Instruction>(new   RES_1_H_In());
     _cb_instructions[0x8D] = std::unique_ptr<Instruction>(new   RES_1_L_In());
     _cb_instructions[0x8E] = std::unique_ptr<Instruction>(new RES_1_mHL_In());
     _cb_instructions[0x8F] = std::unique_ptr<Instruction>(new   RES_1_A_In());
     
     _cb_instructions[0x90] = std::unique_ptr<Instruction>(new   RES_2_B_In()); 
     _cb_instructions[0x91] = std::unique_ptr<Instruction>(new   RES_2_C_In()); 
     _cb_instructions[0x92] = std::unique_ptr<Instruction>(new   RES_2_D_In()); 
     _cb_instructions[0x93] = std::unique_ptr<Instruction>(new   RES_2_E_In()); 
     _cb_instructions[0x94] = std::unique_ptr<Instruction>(new   RES_2_H_In()); 
     _cb_instructions[0x95] = std::unique_ptr<Instruction>(new   RES_2_L_In()); 
     _cb_instructions[0x96] = std::unique_ptr<Instruction>(new RES_2_mHL_In()); 
     _cb_instructions[0x97] = std::unique_ptr<Instruction>(new   RES_2_A_In()); 
     _cb_instructions[0x98] = std::unique_ptr<Instruction>(new   RES_3_B_In()); 
     _cb_instructions[0x99] = std::unique_ptr<Instruction>(new   RES_3_C_In()); 
     _cb_instructions[0x9A] = std::unique_ptr<Instruction>(new   RES_3_D_In()); 
     _cb_instructions[0x9B] = std::unique_ptr<Instruction>(new   RES_3_E_In()); 
     _cb_instructions[0x9C] = std::unique_ptr<Instruction>(new   RES_3_H_In()); 
     _cb_instructions[0x9D] = std::unique_ptr<Instruction>(new   RES_3_L_In()); 
     _cb_instructions[0x9E] = std::unique_ptr<Instruction>(new RES_3_mHL_In()); 
     _cb_instructions[0x9F] = std::unique_ptr<Instruction>(new   RES_3_A_In()); 
     
     _cb_instructions[0xA0] = std::unique_ptr<Instruction>(new   RES_4_B_In());
     _cb_instructions[0xA1] = std::unique_ptr<Instruction>(new   RES_4_C_In());
     _cb_instructions[0xA2] = std::unique_ptr<Instruction>(new   RES_4_D_In());
     _cb_instructions[0xA3] = std::unique_ptr<Instruction>(new   RES_4_E_In());
     _cb_instructions[0xA4] = std::unique_ptr<Instruction>(new   RES_4_H_In());
     _cb_instructions[0xA5] = std::unique_ptr<Instruction>(new   RES_4_L_In());
     _cb_instructions[0xA6] = std::unique_ptr<Instruction>(new RES_4_mHL_In());
     _cb_instructions[0xA7] = std::unique_ptr<Instruction>(new   RES_4_A_In());
     _cb_instructions[0xA8] = std::unique_ptr<Instruction>(new   RES_5_B_In());
     _cb_instructions[0xA9] = std::unique_ptr<Instruction>(new   RES_5_C_In());
     _cb_instructions[0xAA] = std::unique_ptr<Instruction>(new   RES_5_D_In());
     _cb_instructions[0xAB] = std::unique_ptr<Instruction>(new   RES_5_E_In());
     _cb_instructions[0xAC] = std::unique_ptr<Instruction>(new   RES_5_H_In());
     _cb_instructions[0xAD] = std::unique_ptr<Instruction>(new   RES_5_L_In());
     _cb_instructions[0xAE] = std::unique_ptr<Instruction>(new RES_5_mHL_In());
     _cb_instructions[0xAF] = std::unique_ptr<Instruction>(new   RES_5_A_In());
     
     _cb_instructions[0xB0] = std::unique_ptr<Instruction>(new   RES_6_B_In());
     _cb_instructions[0xB1] = std::unique_ptr<Instruction>(new   RES_6_C_In());
     _cb_instructions[0xB2] = std::unique_ptr<Instruction>(new   RES_6_D_In());
     _cb_instructions[0xB3] = std::unique_ptr<Instruction>(new   RES_6_E_In());
     _cb_instructions[0xB4] = std::unique_ptr<Instruction>(new   RES_6_H_In());
     _cb_instructions[0xB5] = std::unique_ptr<Instruction>(new   RES_6_L_In());
     _cb_instructions[0xB6] = std::unique_ptr<Instruction>(new RES_6_mHL_In());
     _cb_instructions[0xB7] = std::unique_ptr<Instruction>(new   RES_6_A_In());
     _cb_instructions[0xB8] = std::unique_ptr<Instruction>(new   RES_7_B_In());
     _cb_instructions[0xB9] = std::unique_ptr<Instruction>(new   RES_7_C_In());
     _cb_instructions[0xBA] = std::unique_ptr<Instruction>(new   RES_7_D_In());
     _cb_instructions[0xBB] = std::unique_ptr<Instruction>(new   RES_7_E_In());
     _cb_instructions[0xBC] = std::unique_ptr<Instruction>(new   RES_7_H_In());
     _cb_instructions[0xBD] = std::unique_ptr<Instruction>(new   RES_7_L_In());
     _cb_instructions[0xBE] = std::unique_ptr<Instruction>(new RES_7_mHL_In());
     _cb_instructions[0xBF] = std::unique_ptr<Instruction>(new   RES_7_A_In());
     
     _cb_instructions[0xC0] = std::unique_ptr<Instruction>(new   SET_0_B_In());
     _cb_instructions[0xC1] = std::unique_ptr<Instruction>(new   SET_0_C_In());
     _cb_instructions[0xC2] = std::unique_ptr<Instruction>(new   SET_0_D_In());
     _cb_instructions[0xC3] = std::unique_ptr<Instruction>(new   SET_0_E_In());
     _cb_instructions[0xC4] = std::unique_ptr<Instruction>(new   SET_0_H_In());
     _cb_instructions[0xC5] = std::unique_ptr<Instruction>(new   SET_0_L_In());
     _cb_instructions[0xC6] = std::unique_ptr<Instruction>(new SET_0_mHL_In());
     _cb_instructions[0xC7] = std::unique_ptr<Instruction>(new   SET_0_A_In());
     _cb_instructions[0xC8] = std::unique_ptr<Instruction>(new   SET_1_B_In());
     _cb_instructions[0xC9] = std::unique_ptr<Instruction>(new   SET_1_C_In());
     _cb_instructions[0xCA] = std::unique_ptr<Instruction>(new   SET_1_D_In());
     _cb_instructions[0xCB] = std::unique_ptr<Instruction>(new   SET_1_E_In());
     _cb_instructions[0xCC] = std::unique_ptr<Instruction>(new   SET_1_H_In());
     _cb_instructions[0xCD] = std::unique_ptr<Instruction>(new   SET_1_L_In());
     _cb_instructions[0xCE] = std::unique_ptr<Instruction>(new SET_1_mHL_In());
     _cb_instructions[0xCF] = std::unique_ptr<Instruction>(new   SET_1_A_In());
     
     _cb_instructions[0xD0] = std::unique_ptr<Instruction>(new   SET_2_B_In());
     _cb_instructions[0xD1] = std::unique_ptr<Instruction>(new   SET_2_C_In());
     _cb_instructions[0xD2] = std::unique_ptr<Instruction>(new   SET_2_D_In());
     _cb_instructions[0xD3] = std::unique_ptr<Instruction>(new   SET_2_E_In());
     _cb_instructions[0xD4] = std::unique_ptr<Instruction>(new   SET_2_H_In());
     _cb_instructions[0xD5] = std::unique_ptr<Instruction>(new   SET_2_L_In());
     _cb_instructions[0xD6] = std::unique_ptr<Instruction>(new SET_2_mHL_In());
     _cb_instructions[0xD7] = std::unique_ptr<Instruction>(new   SET_2_A_In());
     _cb_instructions[0xD8] = std::unique_ptr<Instruction>(new   SET_3_B_In());
     _cb_instructions[0xD9] = std::unique_ptr<Instruction>(new   SET_3_C_In());
     _cb_instructions[0xDA] = std::unique_ptr<Instruction>(new   SET_3_D_In());
     _cb_instructions[0xDB] = std::unique_ptr<Instruction>(new   SET_3_E_In());
     _cb_instructions[0xDC] = std::unique_ptr<Instruction>(new   SET_3_H_In());
     _cb_instructions[0xDD] = std::unique_ptr<Instruction>(new   SET_3_L_In());
     _cb_instructions[0xDE] = std::unique_ptr<Instruction>(new SET_3_mHL_In());
     _cb_instructions[0xDF] = std::unique_ptr<Instruction>(new   SET_3_A_In());
     
     _cb_instructions[0xE0] = std::unique_ptr<Instruction>(new   SET_4_B_In());
     _cb_instructions[0xE1] = std::unique_ptr<Instruction>(new   SET_4_C_In());
     _cb_instructions[0xE2] = std::unique_ptr<Instruction>(new   SET_4_D_In());
     _cb_instructions[0xE3] = std::unique_ptr<Instruction>(new   SET_4_E_In());
     _cb_instructions[0xE4] = std::unique_ptr<Instruction>(new   SET_4_H_In());
     _cb_instructions[0xE5] = std::unique_ptr<Instruction>(new   SET_4_L_In());
     _cb_instructions[0xE6] = std::unique_ptr<Instruction>(new SET_4_mHL_In());
     _cb_instructions[0xE7] = std::unique_ptr<Instruction>(new   SET_4_A_In());
     _cb_instructions[0xE8] = std::unique_ptr<Instruction>(new   SET_5_B_In());
     _cb_instructions[0xE9] = std::unique_ptr<Instruction>(new   SET_5_C_In());
     _cb_instructions[0xEA] = std::unique_ptr<Instruction>(new   SET_5_D_In());
     _cb_instructions[0xEB] = std::unique_ptr<Instruction>(new   SET_5_E_In());
     _cb_instructions[0xEC] = std::unique_ptr<Instruction>(new   SET_5_H_In());
     _cb_instructions[0xED] = std::unique_ptr<Instruction>(new   SET_5_L_In());
     _cb_instructions[0xEE] = std::unique_ptr<Instruction>(new SET_5_mHL_In());
     _cb_instructions[0xEF] = std::unique_ptr<Instruction>(new   SET_5_A_In());
     
     _cb_instructions[0xF0] = std::unique_ptr<Instruction>(new   SET_6_B_In());
     _cb_instructions[0xF1] = std::unique_ptr<Instruction>(new   SET_6_C_In());
     _cb_instructions[0xF2] = std::unique_ptr<Instruction>(new   SET_6_D_In());
     _cb_instructions[0xF3] = std::unique_ptr<Instruction>(new   SET_6_E_In());
     _cb_instructions[0xF4] = std::unique_ptr<Instruction>(new   SET_6_H_In());
     _cb_instructions[0xF5] = std::unique_ptr<Instruction>(new   SET_6_L_In());
     _cb_instructions[0xF6] = std::unique_ptr<Instruction>(new SET_6_mHL_In());
     _cb_instructions[0xF7] = std::unique_ptr<Instruction>(new   SET_6_A_In());
     _cb_instructions[0xF8] = std::unique_ptr<Instruction>(new   SET_7_B_In());
     _cb_instructions[0xF9] = std::unique_ptr<Instruction>(new   SET_7_C_In());
     _cb_instructions[0xFA] = std::unique_ptr<Instruction>(new   SET_7_D_In());
     _cb_instructions[0xFB] = std::unique_ptr<Instruction>(new   SET_7_E_In());
     _cb_instructions[0xFC] = std::unique_ptr<Instruction>(new   SET_7_H_In());
     _cb_instructions[0xFD] = std::unique_ptr<Instruction>(new   SET_7_L_In());
     _cb_instructions[0xFE] = std::unique_ptr<Instruction>(new SET_7_mHL_In());
     _cb_instructions[0xFF] = std::unique_ptr<Instruction>(new   SET_7_A_In());
}           // 0xCB
...
LD_HL_SP_r8_In::LD_HL_SP_r8_In() : Instruction("LD","LD HL, SP+r8", "00HC", 0xF8, 2, 12, VERBOSE_FLAG) { }// 0xF8
 ...
 LD_A_a16_In::LD_A_a16_In(): Instruction(  "LD",   "LD A, a16", "----", 0xFA, 3, 16, VERBOSE_FLAG) { }    // 0xFA
...
void  SBC_mHL_In::op(LR35902& cpu, Memory& memory) { uint8 loaded_hl = memory.read_8(cpu.registers.HL); cpu.sbc_8_8(cpu.registers.A, loaded_hl);} // 0x9E
...
void   JP_NZ_a16_In::op(LR35902& cpu, Memory& memory) { if(cpu.jpf_n(cpu.registers.z(), memory.read_16(cpu.registers.PC + 1))) { cpu.registers.PC -= bytes; addedCycles = 4; } } // 0xC2
void      JP_a16_In::op(LR35902& cpu, Memory& memory) { cpu.jp(memory.read_16(cpu.registers.PC + 1)); cpu.registers.PC -= bytes; }            // 0xC3
...
void  JP_NC_a16_In::op(LR35902& cpu, Memory& memory) { if(cpu.jpf_n(cpu.registers.c(), memory.read_16(cpu.registers.PC + 1))) { cpu.registers.PC -= bytes; addedCycles = 4; } } // 0xD2
// 0xD3: no operation for this opcode in LR35902
...
void  ADD_SP_r8_In::op(LR35902& cpu, Memory& memory) { cpu.registers.SP = cpu.add_sp_n(cpu.registers.SP, memory.read_8(cpu.registers.PC + 1)); 
...
void      POP_AF_In::op(LR35902& cpu, Memory& memory) { uint16 reg; cpu.pop(reg); cpu.registers.AF = reg & 0xFFF0; }  // 0xF1
...
void LD_HL_SP_r8_In::op(LR35902& cpu, Memory& memory) { cpu.registers.HL = cpu.add_sp_n(cpu.registers.SP, memory.read_8(cpu.registers.PC + 1)); }
